...
const LoginForm = () => {
  ...
  useEffect(() => {
    ...
    const handleFocus = (e) => {
      e.target.parentElement.querySelector('p.formLabel').classList.add('formTop');
      document.getElementById('formWrapper').classList.add('darken-bg');
      document.querySelector('div.logo').classList.add('logo-active');
    };

    const handleFocusOut = (e) => {
      if (e.target.value.trim().length === 0) {
        e.target.parentElement.querySelector('p.formLabel').classList.remove('formTop');
      }
      document.getElementById('formWrapper').classList.remove('darken-bg');
      document.querySelector('div.logo').classList.remove('logo-active');
    };

    const handleLabelClick = (e) => {
      e.target.parentElement.querySelector('.form-style').focus();
    };
  ...
  return (
    <div id="formWrapper">
      <div id="form">
        <div className="logo">
          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 458.8 167.5" enableBackground="new 0 0 458.8 167.5" xmlSpace="preserve">
            <g>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-item">
            ...
            <input type="submit" className="login pull-right" value="Log In" />
